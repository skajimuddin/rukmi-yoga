          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              ...
              <div className="space-y-4 order-1 lg:order-2">
                ...
                <p className="text-muted-foreground md:text-lg">
                  At RUKMI YOGA, our mission is to empower individuals to
                  achieve holistic wellness through the power of Ayurveda. We
                  believe that true health comes from balancing mind, body, and
                  spirit, and our products are designed to support this
                  harmonious state of being.
                </p>
                <p className="text-muted-foreground md:text-lg">
                  We are committed to sustainability, ethical sourcing, and
                  preserving the rich heritage of Ayurvedic traditions while
